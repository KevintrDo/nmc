var studentdata = new Vue({
    ...
    data: {
      ...
      computed: {
    getClassForFactLength: function() {
        return function(fact) {
        console.log("Fact:", fact);
        console.log("Length:", fact.trim().length);
        console.log(fact.trim().length > 30 ? 'long-fact' : 'short-fact');
        return fact.trim().length > 30 ? 'long-fact' : 'short-fact';
        };
    }
    },
    methods: {
